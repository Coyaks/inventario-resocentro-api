...
class AuthController extends Controller
{
    ...
    public function login(Request $req)
    {
        ...
        if(!Hash::check($req->password, $user->password)) return Rsp::false('Contraseña incorrecta', 401);
        $userFull = User::getUserWithPerson($user->id);
